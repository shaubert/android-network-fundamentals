...
public class DefaultRequestRecreator implements RequestRecreator<RequestBase, RequestStateBase> {
    ...
    @Override
    public RequestBase recreate(String className, RequestStateBase state) {
        try {
